...
import com.example.qlcuahangtaphoa.DangKy.DangKyActivity;
...
public class DangNhapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Xử lý đăng nhập tự động nếu đã đăng nhập trước đó
    ...
    public void switchView(){
        if (user != null) {
            ...
            Toast.makeText(this, "Đối tượng người dùng không tồn tại", Toast.LENGTH_SHORT).show();
        }
    }
